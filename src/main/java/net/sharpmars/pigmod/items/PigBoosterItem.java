...
public class PigBoosterItem extends Item {
    public PigBoosterItem(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult useOnEntity(ItemStack stack, PlayerEntity user, LivingEntity entity, Hand hand) {
        ...
        {
            if(!((PigEntityMixinInterface) entity).isBoosterInstalled() && ((PigEntity) entity).canBeSaddled())
            {
                ((PigEntityMixinInterface) entity).setBoosterInstalled(true);
